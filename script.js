    ...
    '2026-02-24': {
        ...
        content: `
                ...
                <div class="cards-grid">
                    <div class="info-card">
                        ...
                        <div class="alert-note">
                            <strong>Note:</strong> তুমি দেখতে পাও না, সরাসরি ব্যবহার করো না, কিন্তু সব কাজ Kernel ছাড়া অসম্ভব। Kernel ছাড়া কম্পিউটার = মৃত লোহা।
                        </div>
                    </div>
                    <div class="info-card">
            ...
            <div class="lesson-section">
                ...
                <p><em>খুব গুরুত্বপূর্ণ – Windows খারাপ, Linux ভালো – এমন বলবেন না। এদের design philosophy আলাদা, use-case আলাদা।</em> Properly configured Windows server খুব secure হতে পারে, আবার Poorly configured Linux server খুব insecure হতে পারে।</p>
